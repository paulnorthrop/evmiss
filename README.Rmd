...
This is an old development version of this software. For the current released version on CRAN see [evmissing](https://cran.r-project.org/package=evmissing), installed using

```{r installation, eval = FALSE}
install.packages("evmissing")
```

The `evmiss` package was created to accompany the research paper Simpson, E. S. and Northrop, P. J. (2025) Accounting for missing data when modelling block maxima, which will appear in [Environmetrics in 2026](https://onlinelibrary.wiley.com/loi/1099095x/year/2026).
...
```{r github_installation, eval = FALSE, echo = TRUE}
